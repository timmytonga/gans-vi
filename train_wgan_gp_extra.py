...
from fit_extrasgd import fit_extrasgd
...
trainset1 = DataLoader(CIFAR10(root='.', download=True, transform=transform_train), 
                      batch_size=batch_size, shuffle=True)
trainset2 = DataLoader(CIFAR10(root='.', download=True, transform=transform_train), 
                      batch_size=batch_size, shuffle=True)
...
fit_extrasgd(gen, gen2, gen_opt, disc, disc2, disc_opt, device, n_epochs, trainset1, trainset2, disc_repeats, make_noise, z_dim, disc_loss_fn, gen_loss_fn, display_step, c_lambda, lr)
