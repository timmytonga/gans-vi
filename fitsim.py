...
def fitsim(gen, gen_opt, disc, disc_opt, device, n_epochs, trainset, make_noise, z_dim, disc_loss_fn, gen_loss_fn, display_step, c_lambda, checkpt=True, loadcheckptpath=None):
	# ================================================================== #
